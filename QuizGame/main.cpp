...
int main()
{
    ...
    cout<<"Do you want to reset your score? "<<endl;
    cout<<"press (1) if you want to reset your score "<<endl<<"any other input will be considered no"<<endl;
    cin>>user_input;
    if(user_input=="1")
        score_list[username]=0;
